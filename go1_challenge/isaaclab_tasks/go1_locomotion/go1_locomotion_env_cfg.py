...
# The 8 m training pyramid has seven elevation changes.
TRAINING_MAX_TERRAIN_HEIGHT = 0.05
TRAINING_PYRAMID_ELEVATION_CHANGES = 7
TRAINING_PYRAMID_MIN_STEP_HEIGHT = 0.005
...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        "pyramid_stairs": terrain_gen.MeshPyramidStairsTerrainCfg(
            proportion=0.2,
            step_height_range=(
                TRAINING_PYRAMID_MIN_STEP_HEIGHT,
                TRAINING_MAX_TERRAIN_HEIGHT / TRAINING_PYRAMID_ELEVATION_CHANGES,
            ),
            step_width=0.3,
            platform_width=3.0,
            border_width=1.0,
        ...
        "boxes": terrain_gen.MeshRandomGridTerrainCfg(
            proportion=0.2,
            grid_width=0.45,
            grid_height_range=(0.025, TRAINING_MAX_TERRAIN_HEIGHT),
            platform_width=2.0,
        ),
...
class RewardsCfg:
    ...
    # -- penalties
    # Penalize deviations from the desired trunk height relative to the local
    # terrain. The YAML configuration can override both weight and target height.
